...
def seed():
    with app.app_context():
        ...
        sources = {
            ...
            'superstep':     Source(name='Superstep',    base_url='https://www.superstep.com.tr', vertical='fashion', scraper_type='requests',  crawl_delay_seconds=2, is_active=False),
            'sneaksup':      Source(name='Sneaksup',     base_url='https://www.sneaksup.com',   vertical='fashion',   scraper_type='requests',  crawl_delay_seconds=2, is_active=False),
            'sneakersonline':Source(name='Sneakersonline',base_url='https://www.sneakersonline.com', vertical='fashion', scraper_type='requests', crawl_delay_seconds=2, is_active=False),
